...
if (isset($_POST['send_message'])) {
    ...
    mysqli_stmt_bind_param($stmt, 'iiis', $seller_id, $receiver_id, $property_id, $message);
...
if (isset($_GET['delete_conversation'])) {
    ...
    mysqli_stmt_bind_param($stmt, 'iiiii', $property, $sender, $seller_id, $seller_id, $sender);
    if (mysqli_stmt_execute($stmt)) {
