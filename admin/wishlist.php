...
if ($has_pic_column) {
    $user_query = mysqli_query($conn, "SELECT profile_pic FROM users WHERE id = $admin_id");
...
// ============================================================
// SIDEBAR STATS (matching admin index)
// ============================================================
$stats = [
    'users'   => 0,
    'pending' => 0,
...
// ============================================================
// FETCH WISHLIST PROPERTIES (admin's own wishlist)
// ============================================================
$wishlist_properties = [];
$query = "
    SELECT 
    ...
    WHERE w.user_id = $admin_id AND p.status = 'Active'
...
// ============================================================
// getPropertyImages() – same as before
// ============================================================
...
<head>
    ...
    <title>Admin Wishlist - EstateHub</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
        /* ===== ADMIN LAYOUT (same as admin index) ===== */
