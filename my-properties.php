    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; font-family:'Inter', sans-serif; }
        ...
        .search-box svg{
            ...
            width:18px; height:18px; color:#adb5bd; pointer-events:none;
        }
        .filters-form select{
            padding:10px 14px;
            border-radius:10px;
        ...
        .views-cell small{ display:block; font-size:11px; color:#94a3b8; font-weight:400; }
        ...
        .pagination-bar .showing b{ color:#0b1a2e; }
        ...
        <div class="content-inner">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card c-orange">
                    <div class="stat-top">
                        <div class="stat-icon icon-orange">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="10" y1="8" x2="10" y2="16"/><line x1="14" y1="8" x2="14" y2="16"/></svg>
                        </div>
                    </div>
                    <div class="stat-label">Inactive Listings</div>
                    <div class="stat-number"><?php echo $inactive_properties; ?></div>
                    <div class="stat-growth <?php echo $inactive_growth > 0 ? 'down' : ($inactive_growth < 0 ? 'up' : 'neutral'); ?>">
                        <?php echo $inactive_growth > 0 ? '↘' : ($inactive_growth < 0 ? '↗' : '–'); ?>
                        <?php echo abs($inactive_growth); ?>% from last month
                    </div>
                </div>
                ...
                <div class="stat-card c-purple">
                    ...
                    <div class="stat-growth <?php echo $views_growth > 0 ? 'up' : ($views_growth < 0 ? 'down' : 'neutral'); ?>">
                        <?php echo $views_growth > 0 ? '↗' : ($views_growth < 0 ? '↘' : '–'); ?>
                        <?php echo abs($views_growth); ?>% from last month
                    </div>
                </div>
            </div>
            ...
            <div class="table-card">
                <?php if (empty($properties)): ?>
                    <div class="empty-state">
                        ...
                        <p>No properties found<?php echo ($search || $status_filter || $type_filter || $city_filter) ? ' matching your filters' : ' yet'; ?>.</p>
                        <a href="add-property.php">Add your first property &rarr;</a>
                    </div>
                <?php else: ?>
                    <table>
                        <thead>
                        ...
                        <tbody>
                            <?php foreach ($properties as $p):
                                ...
                                $prop_type  = $p['property_type'] ?? ($p['type'] ?? '—');
                            ...
                            ?>
                                <tr>
                                    <td>
                                        <div class="prop-cell">
                                            <img class="prop-thumb" src="<?php echo !empty($img) ? htmlspecialchars($img) : 'assets/images/property-placeholder.jpg'; ?>" alt="<?php echo htmlspecialchars($p['title']); ?>" onerror="this.src='https://via.placeholder.com/64x56?text=No+Image'">
                                            <div class="prop-info">
                                                <h4><?php echo htmlspecialchars($p['title']); ?></h4>
                                                <div class="meta">
                                                    <?php
                                                        $parts = [];
                                                        if (!is_null($beds))  $parts[] = $beds . ' Beds';
                                                        if (!is_null($baths)) $parts[] = $baths . ' Baths';
                                                        if (!empty($area))    $parts[] = htmlspecialchars($area);
                                                        echo $parts ? implode(' &middot; ', $parts) : '&mdash;';
                                                    ?>
                                                </div>
                                                <div class="prop-id">House ID: #<?php echo htmlspecialchars($house_id); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="type-cell">
                                            ...
                                            <?php echo htmlspecialchars($prop_type); ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="loc-cell">
                                            ...
                                            <div>
                                                ...
                                                <?php if ($city): ?><div class="city"><?php echo htmlspecialchars($city); ?></div><?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="views-cell">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                            <?php echo number_format((int)($p['views'] ?? 0)); ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="actions-cell">
                                            <a href="edit-property.php?id=<?php echo $p['id']; ?>" class="action-btn action-edit" title="Edit">
                                            ...
                                            <a href="property-analytics.php?id=<?php echo $p['id']; ?>" class="action-btn action-stats" title="Analytics">
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
                                            </a>
                                            <a href="my-properties.php?delete=<?php echo $p['id']; ?>" class="action-btn action-delete" title="Delete" onclick="return confirm('Delete this property? This cannot be undone.');">
                    ...
                    <div class="pagination-bar">
                        <div class="showing">
                            Showing <b><?php echo $offset + 1; ?></b> to <b><?php echo min($offset + $per_page, $total_results); ?></b> of <b><?php echo $total_results; ?></b> properties
                        </div>
                        <ul class="pagination">
                            <li><a class="<?php echo $page <= 1 ? 'disabled' : ''; ?>" href="<?php echo qs_with(['page' => max(1, $page - 1)]); ?>">&lsaquo;</a></li>
                            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                <li><a class="<?php echo $i == $page ? 'active' : ''; ?>" href="<?php echo qs_with(['page' => $i]); ?>"><?php echo $i; ?></a></li>
                            <?php endfor; ?>
                            <li><a class="<?php echo $page >= $total_pages ? 'disabled' : ''; ?>" href="<?php echo qs_with(['page' => min($total_pages, $page + 1)]); ?>">&rsaquo;</a></li>
                        </ul>
                    </div>
                <?php endif; ?>
            </div>
